...
description: "雙 AI 對話式審查 — Claude 與 Codex 互審直到共識。觸發：「對話審查」「dialogue review」"
tags: [adapter-wrapper]
---

# review-dialogue

> Adapter skill — 單一真相來源在 `.claude/commands/review-dialogue.md`

讀取並執行 `.claude/commands/review-dialogue.md`。
