---
name: sop-router
description: "SOP 管線統一路由。將用戶的 SOP 意圖路由到 .claude/commands/ 對應指令並執行。觸發：$skill-sop <s0|s1|s2|s3|s4|s5|s6|s7|autopilot|resume|spec-review|spec-converge|spec-audit|review-dialogue|cross-validate|parallel-develop>。"
---
